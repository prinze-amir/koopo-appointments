...
<section class="koopo-booking-details woocommerce-order-booking-details">
  ...
  <table class="woocommerce-table woocommerce-table--booking-details shop_table booking_details">
    <tbody>
      ...
      <tr>
        <th><?php esc_html_e('Total Duration', 'koopo-appointments'); ?></th>
        <td><?php echo esc_html($duration); ?></td>
      </tr>

      <?php if (!empty($addon_titles)): ?>
      <tr>
        <th><?php esc_html_e('Add-ons', 'koopo-appointments'); ?></th>
        <td><?php echo esc_html(implode(', ', $addon_titles)); ?></td>
      </tr>
      <tr>
        <th><?php esc_html_e('Base Duration', 'koopo-appointments'); ?></th>
        <td><?php echo esc_html(Date_Formatter::format_duration($service_duration)); ?></td>
      </tr>
      <tr>
        <th><?php esc_html_e('Add-on Duration', 'koopo-appointments'); ?></th>
        <td><?php echo esc_html(Date_Formatter::format_duration($addon_total_duration)); ?></td>
      </tr>
      <?php endif; ?>
      ...
      <tr>
        <th><?php esc_html_e('Service Price', 'koopo-appointments'); ?></th>
        <td><?php echo wp_kses_post(wc_price($service_price, ['currency' => $currency])); ?></td>
      </tr>
      <?php if (!empty($addon_titles)): ?>
      <tr>
        <th><?php esc_html_e('Add-ons Total', 'koopo-appointments'); ?></th>
        <td><?php echo wp_kses_post(wc_price($addon_total_price, ['currency' => $currency])); ?></td>
      </tr>
      <?php endif; ?>
      <tr>
        <th><?php esc_html_e('Total Price', 'koopo-appointments'); ?></th>
        <td><?php echo wp_kses_post(wc_price((float) $booking->price, ['currency' => $currency])); ?></td>
      </tr>
    </tbody>
  </table>
